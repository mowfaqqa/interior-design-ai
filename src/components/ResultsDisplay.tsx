    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md w-full mx-auto text-center p-8">
          <div className="mb-8">
            <svg className="animate-spin h-12 w-12 text-orange-400 mx-auto mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
          ...
          <div className="space-y-12">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <div className="flex items-center mb-6">
                <svg className="w-6 h-6 text-orange-400 mr-3" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {results.generatedImages?.map((img, i) => (
                  <div key={i} className="relative group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
