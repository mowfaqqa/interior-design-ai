    ...
    <section className="bg-gray-50 py-16 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          {/* Generate Button */}
          <button className="bg-orange-400 hover:bg-orange-500 text-white px-8 py-3 rounded-full font-medium text-lg transition-colors inline-flex items-center mb-12">
            Générer votre image
