...
const CreateLayoutMainSection = () => {
  ...
  const xml: React.ReactElement = (
    <main className="flex gap-[3.5rem] p-[3.5rem] bg-[#242426] h-[calc(100dvh-7rem)] relative">
      <div className="w-[calc((100%-33.4rem)-3.5rem)]">
      ...
      <div className="absolute top-[-1.6rem] left-[12.2rem] w-[22rem] pt-[2.3rem] pb-[0.7rem] rounded-[0.8rem] bg-[#979797] border border-[#444444] text-center z-[1]">
