    ...
    <section className="bg-gray-50 py-20 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center">
          ...
          {/* CTA Button */}
          <button className="bg-orange-400 hover:bg-orange-500 text-white px-8 py-4 rounded-full font-medium text-lg transition-colors inline-flex items-center shadow-lg hover:shadow-xl">
