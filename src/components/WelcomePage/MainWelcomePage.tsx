...
const MainWelcomePage: React.FC = () => {
  const xml: React.ReactElement = (
    <main className="h-[calc(100dvh-7rem)] bg-[#242426] pt-[5.5rem]">
      <h2 className="mb-[4.1rem] font-semibold text-[2.4rem] leading-[120%] text-center tracking-[-0.02em] text-white fustat">
        Bienvenue
      </h2>
      {/* ITEMS */}
      <ScreenScale className="!w-[105.2rem] flex gap-[2.5rem] h-[33.4rem]">
        {/* UPLOAD */}
        ...
        {/*  */}
        <div className="flex-[1_0_0] flex flex-col gap-[2.5rem]">
          <article
        ...
        {/*  */}
        <article className="flex-[1_0_0] flex flex-col justify-center items-center rounded-[0.8rem] bg-[linear-gradient(270deg,_#444444_0%,_#2F2F2F_100%)]">
