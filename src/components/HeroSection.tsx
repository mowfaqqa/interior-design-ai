...
const HeroSection: React.FC = () => {
  return (
    <div className="relative min-h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url("/assets/hero.png")' }}>
      {/* Top Bar */}
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center">
            <div className="text-white text-2xl font-bold mr-2">
              ...
              <svg className="w-8 h-8 mr-2" viewBox="0 0 40 40" fill="currentColor">
                <path d="M20 0L40 20L20 40L0 20Z"/>
                <path d="M20 8L32 20L20 32L8 20Z" fill="rgba(255,255,255,0.3)"/>
              </svg>
            </div>
            <span className="text-white text-xl font-bold">AÏNO</span>
            <span className="text-white text-sm italic ml-2 opacity-75">lets do it together</span>
          </div>

          {/* Navigation Links */}
          <div className="hidden md:flex space-x-8">
            <Link href="/" className="text-white hover:text-orange-200 transition-colors font-medium">
              Home
            </Link>
            <Link href="/pricing" className="text-white hover:text-orange-200 transition-colors font-medium">
              Pricing
            </Link>
            <Link href="/subscription" className="text-white hover:text-orange-200 transition-colors font-medium">
              Subscription
            </Link>
            <Link href="/professionals" className="text-white hover:text-orange-200 transition-colors font-medium">
              Professionals
            </Link>
          </div>

          {/* Generator Button */}
          <button className="bg-orange-400 hover:bg-orange-500 text-white px-6 py-2 rounded-full font-medium transition-colors flex items-center">
            Generator
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-white text-5xl md:text-6xl lg:text-7xl font-light leading-tight mb-12">
            Un simple clic<br />
            transformera votre<br />
            espace
          </h1>

          {/* CTA Button */}
          <button className="bg-orange-400 hover:bg-orange-500 text-white px-8 py-3 rounded-full font-medium text-lg transition-colors inline-flex items-center">
            C&apos;est parti !
